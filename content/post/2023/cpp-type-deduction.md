---
title: "查验C++类型推导结果 | Check C++ Type Deduction Result"
date: 2023-05-16T00:25:39+08:00
lastmod: 2023-05-21T00:25:39+08:00
draft: false
tags: ["C++", "类型推导", "泛型"]
categories: ["技术"]
#math: false
...
由以上可得，对函数类型进行 add c/v/ref 或 remove c/v/ref 操作时，
**如果某种属性是属于函数签名的一部分，那么这种属性就是这个基本类型的一部分，它是不会被改变的。**
而且，**当某种属性属于函数签名的一部分时，是无法通过 is c/v/ref 判断出是否具有这种属性的。**
